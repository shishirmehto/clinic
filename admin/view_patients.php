			...
			<div id="page-wrapper">
				<div class="main-page" style="min-height: 531px;">
					...
					<div class="inbox-page">
						<?php
							$query = "SELECT user.*,patient_information.* FROM user INNER JOIN patient_information on user.userid = patient_information.student_id";
							$res = select($query);
							if(mysqli_num_rows($res)>0)
							{
								...
								<div class="inbox-row widget-shadow" id="accordion<?=$i?>" role="tablist" aria-multiselectable="true">
									<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse<?=$i?>" aria-expanded="true" aria-controls="collapse<?=$i?>">
										...
										<div class="mail-right"><p><?=date('d-m-Y', strtotime($registration_date))?></p></div>
											...
											<div class="row">
												...
												<div class="col-md-12" style="margin-top:20px;">
													...
													<table class="table table-hover table-responsive  table-bordered">
														...
														<?php } else { ?>
														<h4 class="text-center">No Old Records Found</h4>
														<?php } ?>
