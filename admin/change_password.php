					...
					<div class="widget-shadow">
						<div class="login-body">
							<form method="post" id="change_pass">
								<input type="password"  class="lock"  id="opassword" placeholder="Enter Old Password">
								<input type="password" class="lock"  id="password" placeholder="Enter New Password">
								<input type="password" class="lock"  id="cpassword" placeholder="Confirm Password">
								
								<p class="myerror" id="error"></p>
								
								<input type="submit"  id="login_check" value="Change Password">
