					...
					<div class="widget-shadow">
						<div class="login-body">
							<form method="post" id="new_patient">
								<p>Patient Name</p>
								<?php
									$query = "SELECT user.*,patients.* FROM patients INNER JOIN user on patients.userid = user.userid group by patients.userid ";
								?>
			...
			$(window).load(function(){
				...
				$("#new_patient").submit(function(){
					...
					$.ajax({
						url : "ajax/user.php",
						method:"post",
						data:{"userid":userid,"symptoms":symptoms,"medicine":medicine,"doctorid":doctorid,"amount":amount,"new_patient":1},
