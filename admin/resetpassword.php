				...
				<div class="main-page signup-page">
					...
					<form method="post">
						<div class="sign-u">
							...
							<div class="sign-up2">
								<input type="text"  value="<?=$_SESSION['reset_code_admin']?>" readonly id="resetcode">
							</div>
			...
			$(window).load(function(){
				$("#reset").click(function(){
					...
					$.ajax({
						url : "ajax/user.php",
						method:"post",
						data:{"password":password,"cpassword":cpassword,'resetcode':resetcode,"reset_adminid":<?=$_SESSION['reset_adminid']?>,"reset":1},
