			...
			<div id="page-wrapper">
				<div class="main-page" style="min-height: 531px;">
					...
					<div class="inbox-page">
						<?php
							$query = "SELECT patients.*,user.*,patient_information.* FROM patients INNER JOIN user on patients.userid = user.userid left join patient_information on user.userid = patient_information.student_id group by patients.userid ";
							$res = select($query);
															...
															<tbody>
																...
																<?php
																	...
																	<tr>
																		...
																		<td style="word-break: break-all;"><a class="btn btn-primary" href="ajax/user.php?del_report=1&del_report_id=<?=$report_id?>">Delete</a></td>
																	</tr>
																<?php $d_counts++; } ?>
															</tbody>
														</table>
