		...
		<div class="main-content">
			...
			<div id="page-wrapper">
				<div class="main-page login-page ">
					<h3 class="title1">New Patient</h3>
						...
						<div class="login-body">
							<form method="post" id="new_patient">
								...
								<select class="form-control" id="userid">
									<?php
										$query = "SELECT user.*from user LEFT JOIN patients on user.userid = patients.userid WHERE doctorid IS NULL";
										$res = select($query);
										$k = 1;
								...
								<div class="md-form">
									<textarea type="text" id="textareaPrefix" class="form-control symptoms md-textarea animated rotateInUpLeft" placeholder="Patient Symptoms" rows="3"></textarea>
								</div>
								<div class="md-form">
									<textarea type="text" id="textareaPrefix" class="form-control medicine md-textarea animated rotateInUpLeft" placeholder="Medicine Prescribed." rows="3"></textarea>
								</div>
