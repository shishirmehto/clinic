			...
			<div id="page-wrapper">
				<div class="main-page login-page ">
					...
					<div class="widget-shadow">
						<div class="login-top animated infinite pulse">
							<h4>Welcome back to Healthcare Hospital ! <br> Not a Yet Registered ? <a href="signup.php">  Sign Up »</a> </h4>
						</div>
						<div class="login-body">
							<form method="post" id="login_form">
								<input type="text" class="user animated bounceInLeft" id="email" name="email" placeholder="Enter your email">
								<input type="password"  id="password"  name="password" class="lock animated fadeInDown" placeholder="Password">
								<p class="myerror" id="error"></p>
								<input type="submit"  id="login_check" class="animated bounceIn" value="Sign In">
