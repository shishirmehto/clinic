<?php require_once"db/session.php"; extract(mysqli_fetch_array(select("select * from patient_information where student_id='".$_SESSION['userid']."'"))); ?>
<!DOCTYPE HTML>
<html>
	<head>
											...
											<div class="content">
												<div class="main">
													...
													<?php if($date_of_birth!="0000-00-00") { $date = explode("-",$date_of_birth);?>
														...
														echo "<p class='text-center'>Your Age  : $interval->y</p>";
														}
														?>
												</div>
											</div>
